    ...
    internal class BulkObjectFactory : IBulkObjectFactory
    {
        ...
        static BulkObjectFactory()
        {
            IndividualEntityMap = new Dictionary<string, EntityInfo>
            {
                ...
                {StringTable.AccountContentNegativeKeywordList, new EntityInfo(() => new BulkAccountContentNegativeKeywordList())},
                {StringTable.AccountContentNegativeKeywordListAssociation, new EntityInfo(() => new BulkAccountContentNegativeKeywordListAssociation())},
                {StringTable.AccountContentSharedNegativeKeyword, new EntityInfo(() => new BulkAccountContentSharedNegativeKeyword())},
                ...
                {StringTable.AppDownloadGoal, new EntityInfo(() => new BulkAppDownloadGoal())},
