...
namespace Microsoft.BingAds.V13.Internal.Bulk
{
    internal class StringTable
    {
        ...
        public const string BaseDomain = "Base Domain";
        ...
        public const string AccountContentNegativeKeywordList = "Account Content Negative Keyword List";
        public const string AccountContentNegativeKeywordListAssociation = "Account Content Negative Keyword List Association";
        public const string AccountContentSharedNegativeKeyword = "Account Content Shared Negative Keyword";
        ...
        public const string AISearchEnabled = "AI Search Enabled";
        public const string SearchTermMatchingOptOut = "Search Term Matching Opt Out";
        ...
        public const string AppDownloadGoal = "AppDownload Goal";
