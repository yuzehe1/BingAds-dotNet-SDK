...
namespace Microsoft.BingAds.V13.Bulk.Entities
{
    ...
    public class BulkAdGroupUrlTarget : SingleRecordBulkEntity
    {
        /// <summary>
        ...
        private static readonly IBulkMapping<BulkAdGroupUrlTarget>[] Mappings =
        {
            new SimpleBulkMapping<BulkAdGroupUrlTarget>(StringTable.Status,
            ...
            new SimpleBulkMapping<BulkAdGroupUrlTarget>(StringTable.Id,
                c => c.BiddableAdGroupCriterion.Id.ToBulkString(),
                (v, c) => c.BiddableAdGroupCriterion.Id = v.ParseOptional<long>()
            ),

            new SimpleBulkMapping<BulkAdGroupUrlTarget>(StringTable.ParentId,
                c => c.BiddableAdGroupCriterion.AdGroupId.ToBulkString(true),
                (v, c) => c.BiddableAdGroupCriterion.AdGroupId = v.Parse<long>()
            ),

            new SimpleBulkMapping<BulkAdGroupUrlTarget>(StringTable.Campaign,
                c => c.CampaignName,
                (v, c) => c.CampaignName = v
            ),

            new SimpleBulkMapping<BulkAdGroupUrlTarget>(StringTable.AdGroup,
                c => c.AdGroupName,
                (v, c) => c.AdGroupName = v
            ),
            ...
            new ComplexBulkMapping<BulkAdGroupUrlTarget>(
                (c, v) =>
                {
                    ...
                    WebpageConditionHelper.AddRowValuesFromConditions(webpageParameter.Conditions, v, StringTable.AdGroupUrlTargetCondition1, StringTable.AdGroupUrlTargetValue1, StringTable.AdGroupUrlTargetOperator1);
                },
                (v, c) =>
                {
                    var webpage = c.BiddableAdGroupCriterion.Criterion as Webpage;
                    ...
                    if (webpage.Parameter != null)
                    {
                        ...
                        WebpageConditionHelper.AddConditionsFromRowValues(v, webpage.Parameter.Conditions, StringTable.AdGroupUrlTargetCondition1, StringTable.AdGroupUrlTargetValue1, StringTable.AdGroupUrlTargetOperator1);
                    }                    
                }
                ),

            new SimpleBulkMapping<BulkAdGroupUrlTarget>(StringTable.Name,
                c =>
                {
                    var webpage = c.BiddableAdGroupCriterion.Criterion as Webpage;
